...
/* harmony default export */ __webpack_exports__["default"] = ({
    created: function created() {
        ...
        axios.get('/nova-vendor/price-tracker/endpoint').then(function (res) {
            _this.someText = res.data;
        });
    },
    data: function data() {
        return {
...
var render = function() {
  ...
  return _c("div", [
    _c("h1", [
      _vm._v("This Is Just For Price Tracker Tool test " + _vm._s(_vm.someText))
    ])
  ])
}
var staticRenderFns = []
